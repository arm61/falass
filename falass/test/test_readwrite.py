...
class TestFiles(unittest.TestCase):
    ...
    def test_read_pdb(self):
        ...
        for i in range(0, 2):
            assert_equal(pdb.atoms[i * 3][0].zpos, 01.000)
            assert_equal(pdb.atoms[i * 3][1].zpos, 02.000)
            assert_equal(pdb.atoms[i * 3][2].zpos, 03.000)
            assert_equal(pdb.atoms[i * 3 + 1][0].zpos, 03.000)
            assert_equal(pdb.atoms[i * 3 + 1][1].zpos, 01.000)
            assert_equal(pdb.atoms[i * 3 + 1][2].zpos, 02.000)
            assert_equal(pdb.atoms[i * 3 + 2][0].zpos, 02.000)
            assert_equal(pdb.atoms[i * 3 + 2][1].zpos, 03.000)
            assert_equal(pdb.atoms[i * 3 + 2][2].zpos, 01.000)
    ...
    def test_read_pdb_flip(self):
        ...
        for i in range(0, len(pdb.atoms)):
            ...
            assert_equal(pdb.atoms[i][2].atom, 'C3')
        for i in range(0, 2):
            assert_equal(pdb.atoms[i * 3][0].zpos, 03.000)
            assert_equal(pdb.atoms[i * 3][1].zpos, 02.000)
            assert_equal(pdb.atoms[i * 3][2].zpos, 01.000)
            assert_equal(pdb.atoms[i * 3 + 1][0].zpos, 01.000)
            assert_equal(pdb.atoms[i * 3 + 1][1].zpos, 03.000)
            assert_equal(pdb.atoms[i * 3 + 1][2].zpos, 02.000)
            assert_equal(pdb.atoms[i * 3 + 2][0].zpos, 02.000)
            assert_equal(pdb.atoms[i * 3 + 2][1].zpos, 01.000)
            assert_equal(pdb.atoms[i * 3 + 2][2].zpos, 03.000)
        assert_equal(pdb.cell, [[1.000, 1.000, 4.000], [2.000, 1.000, 4.000], [3.000, 1.000, 4.000],
                                [4.000, 1.000, 4.000], [5.000, 1.000, 4.000], [6.000, 1.000, 4.000]])
        return
